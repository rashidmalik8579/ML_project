...
:start
@start "" "League of Legends.exe" "spectator spectator.euw1.lol.riotgames.com:80 ufweT/4NfPmPVhnmjq0A7vMBiRa/4W66 6137097332 EUW1" -UseRads -GameBaseDir=.. "-Locale=%locale%" -SkipBuild -EnableCrashpad=true -EnableLNP
goto exit
